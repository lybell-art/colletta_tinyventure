...
//		d.camera.zoom=d.ratio;
	...
	function INGAME()
	{
		...
		this.run=function()
		{
			...
			d.camera.position.x=d.constrain(p.position.x,960*p.scale,this.world.width-960*p.scale);
			d.camera.position.y=d.constrain(p.position.y,540*p.scale,this.world.height-540*p.scale);
